...
const addSummarySheet = (workbook, summary) => {
  ...
  worksheet.addRows([
    ...
    { Concepto: 'Base', Valor: `${summary.exportOperationalSplit.base.units} viandas` },
    { Concepto: 'Extras post reporte', Valor: `${summary.exportOperationalSplit.postReportExtras.units} viandas` },
    { Concepto: 'Total operativo', Valor: `${summary.exportOperationalSplit.total.units} viandas` },
